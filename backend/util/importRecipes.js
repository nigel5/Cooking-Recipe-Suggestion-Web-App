...
module.exports = function(recipeModel, recipeIngredientIndexModel, recipeStepModel, recipeIngredientModel) {
    ...
    recipeIngredientIndexModel.bulkCreate(bulkRecipeIngredientIndex, {
        ignoreDuplicates: true
    })
    .then(() => {
        console.log(`Inserted/updated ${bulkRecipes.length} recipe to ingredients index`);
    })
}